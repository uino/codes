...
const int scePin = 3;   // SCE - Chip select, pin 3 on LCD.7
const int rstPin = 4;   // RST - Reset, pin 4 on LCD.6
const int dcPin = 5;    // DC - Data/Command, pin 5 on LCD.5
const int sdinPin = 11;  // DN(MOSI) - Serial data, pin 6 on LCD.11
const int sclkPin = 13;  // SCLK - Serial clock, pin 7 on LCD. 13
const int blPin = 9;    // LED - Backlight LED, pin 8 on LCD. 9
